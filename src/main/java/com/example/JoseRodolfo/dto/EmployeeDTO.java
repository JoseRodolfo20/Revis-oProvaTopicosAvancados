package com.example.JoseRodolfo.dto;
...
public class EmployeeDTO {
    ...
    @NotEmpty(message = "As horas extras trabalhadas pode ser vazio.")
    private String extraWorkedHours;

    @NotNull(message = "A ultima data de treinamento não pode ser null.")
    @NotEmpty(message = "A ultima data de treinamento não pode ser vazio.")
